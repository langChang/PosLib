...
public final class PixelUtil {
    ...
    public static String getMac(Context context) {
        ...
        if (strMac == null) {
            ...
            SettingDao.saveMacAddress(strMac.toUpperCase().replace(":", "-"));
    ...
    public static String getMACAddress(String interfaceName) {
        if(!TextUtils.isEmpty(SettingDao.getMacAddress1())){
            return SettingDao.getMacAddress1();
        }
        ...
        try {
            ...
            for (NetworkInterface intf : interfaces) {
                ...
                String replaceMac = buf.toString().toUpperCase().replace(":", "-");
                SettingDao.saveMacAddress1(replaceMac);
