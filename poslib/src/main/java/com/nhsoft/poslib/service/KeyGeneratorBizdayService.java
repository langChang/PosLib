...
@Entity
public class KeyGeneratorBizdayService {

    private static KeyGeneratorBizdayService instance;

    public static KeyGeneratorBizdayService getInstance() {
        if (instance == null) {
            instance = new KeyGeneratorBizdayService();
        }
        return instance;
    }
