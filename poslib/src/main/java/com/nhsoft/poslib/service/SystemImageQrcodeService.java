...
public class SystemImageQrcodeService {

    private static SystemImageQrcodeService instance;

    public static SystemImageQrcodeService getInstance(){
        if (instance==null){
            instance=new SystemImageQrcodeService();
        }
        return instance;
    }
