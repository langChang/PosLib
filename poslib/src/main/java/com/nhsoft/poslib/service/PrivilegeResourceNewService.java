 ...
 * 此类用于：权限资源
 */
public class PrivilegeResourceNewService {

    private static PrivilegeResourceNewService instance;

    public static PrivilegeResourceNewService getInstance() {
        if (instance == null) {
            instance = new PrivilegeResourceNewService();
        }
        return instance;
    }
