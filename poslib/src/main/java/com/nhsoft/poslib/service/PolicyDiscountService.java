...
public class PolicyDiscountService {
    private static PolicyDiscountService instance;

    public static PolicyDiscountService getInstance(){

        if (instance==null){
            instance=new PolicyDiscountService();
        }
        return instance;
    }
