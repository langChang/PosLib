...
public class PolicyPresentService {
    private static PolicyPresentService instance;

    public static PolicyPresentService getInstance(){

        if (instance==null){
            instance=new PolicyPresentService();
        }
        return instance;
    }
