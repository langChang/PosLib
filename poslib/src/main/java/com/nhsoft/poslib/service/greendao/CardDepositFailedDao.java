...
/** 
 * DAO for table "CARD_DEPOSIT_FAILED".
*/
public class CardDepositFailedDao extends AbstractDao<CardDepositFailed, Long> {

    public static final String TABLENAME = "CARD_DEPOSIT_FAILED";

    /**
     * Properties of entity CardDepositFailed.<br/>
    ...
    public static class Properties {
        ...
        public final static Property Card_print_num = new Property(41, String.class, "card_print_num", false, "CARD_PRINT_NUM");
        public final static Property Card_phone = new Property(42, String.class, "card_phone", false, "CARD_PHONE");
        public final static Property Card_type = new Property(43, String.class, "card_type", false, "CARD_TYPE");
        public final static Property Card_user_num = new Property(44, String.class, "card_user_num", false, "CARD_USER_NUM");
    ...
    public CardDepositFailedDao(DaoConfig config) {
        super(config);
    }
    
    public CardDepositFailedDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"CARD_DEPOSIT_FAILED\" (" + //
                ...
                "\"CARD_PRINT_NUM\" TEXT," + // 41: card_print_num
                "\"CARD_PHONE\" TEXT," + // 42: card_phone
                "\"CARD_TYPE\" TEXT," + // 43: card_type
                "\"CARD_USER_NUM\" TEXT," + // 44: card_user_num
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"CARD_DEPOSIT_FAILED\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, CardDepositFailed entity) {
        stmt.clearBindings();
        ...
        if (card_print_num != null) {
            stmt.bindString(42, card_print_num);
        }
 
        String card_phone = entity.getCard_phone();
        if (card_phone != null) {
            stmt.bindString(43, card_phone);
        }
 
        String card_type = entity.getCard_type();
        if (card_type != null) {
            stmt.bindString(44, card_type);
        }
 
        String card_user_num = entity.getCard_user_num();
        if (card_user_num != null) {
            stmt.bindString(45, card_user_num);
        }
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, CardDepositFailed entity) {
        stmt.clearBindings();
    ...
    @Override
    public CardDepositFailed readEntity(Cursor cursor, int offset) {
        CardDepositFailed entity = new CardDepositFailed( //
            ...
            cursor.isNull(offset + 41) ? null : cursor.getString(offset + 41), // card_print_num
            cursor.isNull(offset + 42) ? null : cursor.getString(offset + 42), // card_phone
            cursor.isNull(offset + 43) ? null : cursor.getString(offset + 43), // card_type
            cursor.isNull(offset + 44) ? null : cursor.getString(offset + 44), // card_user_num
    ...
    @Override
    public void readEntity(Cursor cursor, CardDepositFailed entity, int offset) {
        ...
        entity.setCard_print_num(cursor.isNull(offset + 41) ? null : cursor.getString(offset + 41));
        entity.setCard_phone(cursor.isNull(offset + 42) ? null : cursor.getString(offset + 42));
        entity.setCard_type(cursor.isNull(offset + 43) ? null : cursor.getString(offset + 43));
        entity.setCard_user_num(cursor.isNull(offset + 44) ? null : cursor.getString(offset + 44));
    ...
    @Override
    protected final Long updateKeyAfterInsert(CardDepositFailed entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(CardDepositFailed entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(CardDepositFailed entity) {
