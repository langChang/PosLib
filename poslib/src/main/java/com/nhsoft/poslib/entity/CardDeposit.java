...
public class CardDeposit {
    ...
    private String deposit_old_fid;//是否已有单退款，不为空 则是
    ...
    @Generated(hash = 699132704)
    public CardDeposit(Long id, String deposit_fid, String system_book_code,
            ...
            String deposit_synch_date, String deposit_source,
            String deposit_old_fid, String card_print_num, String card_phone,
            String card_type, String deposit_crypt, Boolean from_pos,
            String re_send_fid) {
        this.id = id;
        ...
        this.deposit_old_fid = deposit_old_fid;
    ...
    public String getDeposit_old_fid() {
        return this.deposit_old_fid;
    }
    public void setDeposit_old_fid(String deposit_old_fid) {
        this.deposit_old_fid = deposit_old_fid;
    }
