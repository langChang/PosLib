...
public class PayStyleToCashBankImpl {

    private static PayStyleToCashBankImpl instance;

    public static PayStyleToCashBankImpl getInstance(){
        if (instance==null){
            instance=new PayStyleToCashBankImpl();
        }
        return instance;
    }
