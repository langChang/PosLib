...
public class ChangeGoodsMenuImpl {
    private static ChangeGoodsMenuImpl instance;

    public static ChangeGoodsMenuImpl getInstance() {
        if (instance == null) {
            instance = new ChangeGoodsMenuImpl();
        }
        return instance;
    }
