...
public class VipSendCardImpl {

    private static VipSendCardImpl instance;

    public static VipSendCardImpl getInstance() {
        if (instance == null) {
            instance = new VipSendCardImpl();
        }
        return instance;
    }
...
//        customerRegister.setVip_card_user_print_num(print_num);
        ...
        CustomerRegisterImpl.getInstance().insertBean(customerRegister);
