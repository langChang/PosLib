 ...
 * CRM 开卡会员
 */
public class CustomerRegisterImpl {

    private static CustomerRegisterImpl instance;

    public static CustomerRegisterImpl getInstance() {

        if (instance == null) {
            instance = new CustomerRegisterImpl();
        }
        return instance;
    }
