...
public class VipCrmLevelImpl {

    private static VipCrmLevelImpl instance;

    public static VipCrmLevelImpl getInstance() {
        if (instance == null) {
            instance = new VipCrmLevelImpl();
        }
        return instance;
    }
    ...
    public List<VipCRMLevel> getVipCrmLevelFeeList() {
        ...
        List<VipCrmAmaLevel> unVipCrmAmaLevelList = VipCrmAmaLevelImpl.getInstance().getVipCrmAmaLevelList();
