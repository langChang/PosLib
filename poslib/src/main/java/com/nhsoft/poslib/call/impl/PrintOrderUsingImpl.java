...
public class PrintOrderUsingImpl {

    private static PrintOrderUsingImpl instance;

    public static PrintOrderUsingImpl getInstance(){

        if (instance==null){
            instance=new PrintOrderUsingImpl();
        }
        return instance;
    }
