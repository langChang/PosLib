...
import com.nhsoft.poslib.normal.callback.GoodsDataCallback;
            ...
            if (itemCategoryList.size() > 0) {
                ...
                for (GoodsGradeBean gradeBean : goodsGradeBeanList) {
                    ...
                    if (gradeBean.getItemCategories() == null || gradeBean.getItemCategories().size() == 0) {
                        posItemByCode = PosItemService.getAllShoWPosItemByCode(gradeBean.getCategory_code(), 0);//只有一级类
                        ...
                        for (ItemCategory sonItemCategory : gradeBean.getItemCategories()) {
                            posItemByCode = PosItemService.getAllShoWPosItemAndSonPosItemByCode(sonItemCategory.getCategory_code(), 0);//一级类以下
                            if (posItemByCode != null && posItemByCode.size() > 0) {
                        ...
                        posItemByCode = PosItemService.getAllShoWPosItemByCode(gradeBean.getCategory_code(), 0);
            ...
            if (itemCategoryList.size() > 0) {
                ...
                for (GoodsGradeBean gradeBean : goodsGradeBeanList) {
                    ...
                    if (gradeBean.getItemCategories() == null || gradeBean.getItemCategories().size() == 0) {
                        ...
                        for (ItemCategory sonItemCategory : gradeBean.getItemCategories()) {
                            posItemByCode = PosItemService.getAllShoWPosItemByCode(sonItemCategory.getCategory_code(), 0);
                            if (posItemByCode != null && posItemByCode.size() > 0) {
                                LibConfig.activityDisplayShowGoods.addAll(posItemByCode);
                                sonItemCategory.setPosItemList(posItemByCode);
                                newItemCategorys.add(sonItemCategory);
