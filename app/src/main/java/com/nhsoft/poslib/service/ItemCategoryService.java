...
public class ItemCategoryService {
    ...
    private static ItemCategoryService instance;
    public static ItemCategoryService getInstance(){
        if (instance==null){
            instance=new ItemCategoryService();
        }
        return instance;
    }
    ...
    public int getIndexOfItemSpecification(String categoryName){
        int index=0;
        List<MeasureUnitItem>itemList=MeasureUnitService.getInstance().getMeasureUnitList("系统默认组");;
        for (int i=0;i<itemList.size();i++){
