...
public class PosItemGradeTerminalService {
    private static PosItemGradeTerminalService instance;

    public static PosItemGradeTerminalService getInstance() {
        if (instance == null) {
            instance = new PosItemGradeTerminalService();
        }
        return instance;
    }
    ...
    public  List<PosItemGrade> getAllPosItemGrade(){
        ...
        for(PosItemGradeTerminal posItemGradeTerminal:posItemTerminalList){
            PosItemGrade posItemGrade=PosItemService.getInstance().getPosItemGradeByKey(posItemGradeTerminal.getItem_grade_num(),posItemGradeTerminal.getItem_num());
